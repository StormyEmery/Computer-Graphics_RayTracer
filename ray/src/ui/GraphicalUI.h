...
public:
	...
	int getThreadNum() {return m_nThreads;}
...
private:
	...
	static void cb_thread(Fl_Widget* o, void* v);
	...
	static void cb_cmCheckButton(Fl_Widget* o, void* v);
	...
	static void helperTrace(int start, int end, int y);
